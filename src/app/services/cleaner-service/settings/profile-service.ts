...
// Updated User Profile Interfaces
...
export class ProfileService {
  ...
  // Get user profile by ID (Updated endpoint)
  ...
  createPaymentMethod(paymentData: CreatePaymentMethodRequest): Observable<ApiResponse<PaymentMethod>> {
  ...
  updatePaymentMethod(paymentMethodId: number, paymentData: UpdatePaymentMethodRequest): Observable<ApiResponse<PaymentMethod>> {
    return this.http.put<ApiResponse<PaymentMethod>>(
      `${this.baseURL}/cleaner/api/payment-methods/${paymentMethodId}/`,
      paymentData,
      { headers: this.getHeaders() }
    );
  }

  deletePaymentMethod(paymentMethodId: number): Observable<ApiResponse<any>> {
