...
var w2 = (e = {}) => {
  ...
  return { preset(s3) {
    ...
    var o, c;
    let { semantic: i2 } = t || {}, a2 = s3 && Object.hasOwn(s3, "light") ? s3.light : s3, n = s3 && Object.hasOwn(s3, "dark") ? s3.dark : s3, l = { colorScheme: { light: h(h({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: h(h({}, (c = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c.dark), !!n && { surface: n }) } };
    return t = $(h({}, t), { semantic: h(h({}, i2), l) }), this;
    ...
    let a2 = { preset: s3 ? U(S.getPreset(), t) : t, options: i2 ? h(h({}, S.getOptions()), r) : r };
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  return { type: "attr", selector: `:root,:host${e}`, matched: this.pattern.test(e.trim()) };
  ...
  if (s(t) && r.transform !== "strict") {
    let y = e.replace("-directive", ""), m2 = t, { colorScheme: R, extend: T, css: j } = m2, O = v(m2, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M } = d, z2 = v(d, ["colorScheme"]), u = R || {}, { dark: V } = u, L = v(u, ["dark"]), g = M || {}, { dark: te } = g, re = v(g, ["dark"]), K = s(O) ? this._toVariables({ [y]: h(h({}, O), z2) }, r) : {}, A = s(L) ? this._toVariables({ [y]: h(h({}, L), re) }, r) : {}, X = s(V) ? this._toVariables({ [y]: h(h({}, V), te) }, r) : {}, [G2, U2] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x = A.declarations) != null ? x : "", A.tokens || []], [H, W] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H, "dark", "variable", r, i2, a2, n);
  ...
  return r === "class" || r === "attr" ? C(s(t) ? `${e}${t},${e} ${t}` : e, s3) : C(e, C(t != null ? t : ":root,:host", s3));
}, transformCSS(e, t, r, s3, i2 = {}, a2, n, l) {
  if (s(t)) {
    let { cssLayer: o } = i2;
    if (s3 !== "style") {
      let c = this.getColorSchemeOption(i2, n);
      t = r === "dark" ? c.reduce((m2, { type: d, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l, d, t)), m2), "") : C(l != null ? l : ":root,:host", t);
    }
    if (o) {
...
//# sourceMappingURL=chunk-MSFL4X2L.js.map
