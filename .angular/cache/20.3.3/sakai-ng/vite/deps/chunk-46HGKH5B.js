...
function Message_Conditional_0_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Message_Conditional_0_Conditional_2_ng_container_0_Template, 1, 0, "ng-container", 5);
  }
  if (rf & 2) {
...
function Message_Conditional_0_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Message_Conditional_0_Conditional_4_ng_container_0_Template, 1, 0, "ng-container", 6);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function Message_Conditional_0_Conditional_5_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, Message_Conditional_0_Conditional_5_div_0_span_1_Template, 1, 2, "span", 9);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function Message_Conditional_0_Conditional_5_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Message_Conditional_0_Conditional_5_ng_template_1_span_0_Template, 2, 2, "span", 11);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(3);
...
function Message_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Message_Conditional_0_Conditional_5_div_0_Template, 2, 1, "div", 7)(1, Message_Conditional_0_Conditional_5_ng_template_1_Template, 1, 1, "ng-template", null, 0, ɵɵtemplateRefExtractor);
...
function Message_Conditional_0_Conditional_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Message_Conditional_0_Conditional_6_Conditional_2_ng_container_0_Template, 1, 0, "ng-container", 5);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(3);
...
function Message_Conditional_0_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(1, Message_Conditional_0_Conditional_6_Conditional_1_Template, 1, 3, "i", 13);
    ɵɵconditionalCreate(2, Message_Conditional_0_Conditional_6_Conditional_2_Template, 1, 1, "ng-container");
    ɵɵconditionalCreate(3, Message_Conditional_0_Conditional_6_Conditional_3_Template, 1, 2, ":svg:svg", 14);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function Message_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(4, Message_Conditional_0_Conditional_4_Template, 1, 4, "ng-container")(5, Message_Conditional_0_Conditional_5_Template, 5, 3);
    ɵɵconditionalCreate(6, Message_Conditional_0_Conditional_6_Template, 4, 6, "button", 4);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵclassMap(ctx_r0.cn(ctx_r0.cx("root"), ctx_r0.styleClass));
    ɵɵproperty("@messageAnimation", ɵɵpureFunction1(14, _c5, ɵɵpureFunction2(11, _c4, ctx_r0.showTransitionOptions, ctx_r0.hideTransitionOptions)));
...
var Message = class _Message extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 1,
    vars: 1,
    consts: [["escapeOut", ""], [1, "p-message", "p-component", 3, "class"], [1, "p-message", "p-component"], [3, "class"], ["pRipple", "", "type", "button", 3, "class"], [4, "ngTemplateOutlet"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [4, "ngIf", "ngIfElse"], [3, "ngClass"], [3, "ngClass", "innerHTML", 4, "ngIf"], [3, "ngClass", "innerHTML"], [3, "ngClass", 4, "ngIf"], ["pRipple", "", "type", "button", 3, "click"], [3, "class", "ngClass"], ["data-p-icon", "times", 3, "class"], ["data-p-icon", "times"]],
    template: function Message_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵconditionalCreate(0, Message_Conditional_0_Template, 7, 16, "div", 1);
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-46HGKH5B.js.map
